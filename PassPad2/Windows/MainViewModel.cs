...
namespace Passpad.Windows
{
	class MainObservableObject : ObservableObject
	{
		...
		private PPTheme _theme;
		public PPTheme Theme
		{
			get { return _theme; }
		...
		public IBrush EditorForeground
		{
			get
			{
				switch (Theme)
				{
					case PPTheme.Normal: return Brushes.Black;
					case PPTheme.Invisible: return Brushes.White;
					case PPTheme.LowContrastDark: return new SolidColorBrush(Color.FromRgb(128, 128, 128));
					case PPTheme.LowContrastLight: return new SolidColorBrush(Color.FromRgb(192, 192, 192));
		...
		public IBrush EditorBackground
		{
			get
			{
				switch (Theme)
				{
					case PPTheme.Normal: return Brushes.White;
					case PPTheme.Invisible: return Brushes.White;
					case PPTheme.LowContrastDark: return new SolidColorBrush(Color.FromRgb(105, 105, 105));
					case PPTheme.LowContrastLight: return new SolidColorBrush(Color.FromRgb(220, 220, 220));
					default: throw new ArgumentOutOfRangeException();
				}
			}
		}
		...
		public MainObservableObject()
		{
			this.owner = new Window();

			_document = PasspadDocument.NewEmpty();
		}
